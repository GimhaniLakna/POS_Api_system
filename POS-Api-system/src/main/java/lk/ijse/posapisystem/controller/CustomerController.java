package lk.ijse.posapisystem.controller;
...
import lk.ijse.posapisystem.bo.BOFactory;
...
public class CustomerController extends HttpServlet {
    ...
    static Logger logger = (Logger) LoggerFactory.getLogger(CustomerController.class);
