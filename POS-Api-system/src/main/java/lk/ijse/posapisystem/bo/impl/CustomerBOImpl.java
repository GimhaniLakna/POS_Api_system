...
import lk.ijse.posapisystem.bo.custom.CustomerBO;
import lk.ijse.posapisystem.dao.DAOFactory;
import lk.ijse.posapisystem.dao.custom.CustomerDAO;
import lk.ijse.posapisystem.dto.CustomerDTO;
import lk.ijse.posapisystem.entity.Customer;
...
public class CustomerBOImpl implements CustomerBO {
        ...
        CustomerDAO customerDAO = (CustomerDAO) DAOFactory.getDaoFactory().
        ...
        public boolean saveCustomer(CustomerDTO dto, Connection connection) throws SQLException {
            return customerDAO.save(new Customer(dto.getCustomerId(),
                    dto.getCustomerName(), dto.getCustomerAddress(), dto.getCustomerTel()),connection);
        }

        @Override
        public boolean updateCustomer(String customerId, CustomerDTO customerDTO, Connection connection) {
            Customer customer = new Customer(customerId, customerDTO.getCustomerName(),
                    customerDTO.getCustomerAddress(), customerDTO.getCustomerTel());
